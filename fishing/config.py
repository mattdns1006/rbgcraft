...
OUTPUT_FOLDER = Path(r"D:\00_DEV\00.1-rgbcraft-1\temp")  # where to save outputs (images/audio plots) for debugging
PIX_X, PIX_Y = 1920, 1080  # size of screen in pixels
SEC = 1
